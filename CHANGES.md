...
- [🐛 Language Descriptor Improvement [fix, update, add, suppress some keywords] by @The-Lum](https://github.com/plantuml/plantuml/pull/2336)
- [🐛 Improve WBS declaration (with `Direction`, `Code`) by @The-Lum](https://github.com/plantuml/plantuml/pull/2346)
- [✨ WBS improve declaration (force order of parameters) by @The-Lum](https://github.com/plantuml/plantuml/pull/2362)
