## V1.2026.8 (Sep 5, 2026)
  - [⚡️ Cache SkinParam.getThickness by @lemonlion](https://github.com/plantuml/plantuml/pull/2838)
  - [🍵 Faster SVG number and color formatting in the TeaVM backend by @lemonlion](https://github.com/plantuml/plantuml/pull/2837)
  - [⚡️ Teoz: cache the component in NoteTile, CommunicationTileSelf and CommunicationExoTile by @lemonlion](https://github.com/plantuml/plantuml/pull/2839)
  - [⚡️ Teoz: cache the ArrowComponent in CommunicationTile by @lemonlion](https://github.com/plantuml/plantuml/pull/2836)
  - [🍵 Add perf-bench: non-blocking render performance tracking for the browser engine by @lemonlion](https://github.com/plantuml/plantuml/pull/2840)
  - [⚡️ Teoz: O(1) event lookup in LiveBoxes isNextEventADestroy and getActivateColor by @lemonlion](https://github.com/plantuml/plantuml/pull/2835)
  - [🍵 Support `!theme` in the browser (TeaVM) build by @lemonlion](https://github.com/plantuml/plantuml/pull/2848)
  - [🍵 Paint the document background in the browser (TeaVM) build (stacked on #2848) by @lemonlion](https://github.com/plantuml/plantuml/pull/2849)
  - [🐛 objectdiagram: preserve association link direction by @onuracar-dev](https://github.com/plantuml/plantuml/pull/2843)
  - [🍵 TeaVM: readable error instead of an unhandled exception when viz-global.js is missing by @lemonlion](https://github.com/plantuml/plantuml/pull/2851)
  - [🍵 TeaVM: honor '!pragma layout smetana' in the browser build by @lemonlion](https://github.com/plantuml/plantuml/pull/2852)
  - [👷 Rename action job from 'themes' to 'checks' and add Gradle title by @The-Lum](https://github.com/plantuml/plantuml/pull/2863)
  - [🍵 Smetana performance: dictionary and debug trace hot paths no longer construct exceptions by @lemonlion](https://github.com/plantuml/plantuml/pull/2858)
  - [⚡️ Class diagrams: compile the URL regexp in isMethod once by @lemonlion](https://github.com/plantuml/plantuml/pull/2860)
  - [🍵 TeaVM: fall back to Smetana when viz-global.js is not loaded by @lemonlion](https://github.com/plantuml/plantuml/pull/2861)
  - [♻️ Add README to `site` folder and reorganize JDepend tools by @The-Lum](https://github.com/plantuml/plantuml/pull/2869)
  - [👷 update sonar action and `GPL_ONLY` var. usage by @The-Lum](https://github.com/plantuml/plantuml/pull/2871)
  - [👷 perf-bench: recenter expected bands on the measured ratios by @lemonlion](https://github.com/plantuml/plantuml/pull/2862)
  - [📝 Document missing Javadoc @param tags #2629 by @AzazelSensei](https://github.com/plantuml/plantuml/pull/2850)
  - [🍵 Stdlib includes for every host of the browser engine: PLANTUML_STDLIB_BASE and PLANTUML_STDLIB_LOADER by @lemonlion](https://github.com/plantuml/plantuml/pull/2873)

## V1.2026.7 (Aug 25, 2026)
  - [🐛 fix erroneous compilation timestamp](https://github.com/plantuml/plantuml/commit/88bb12f8ffc7d1fff6807390f835f21078c95582)
  - [🐛 allow embedded sub-diagram on class diagram](https://github.com/plantuml/plantuml/issues/2690)
  - [🐾 improve error message on old (with @startuml) `nwdiag` or `salt` input](https://github.com/plantuml/plantuml/issues/2603)
  - [🐛 fix escaping logic for regex group printing](https://github.com/plantuml/plantuml/issues/1929)
  - [🐛 improve stereostyle and style management](https://github.com/plantuml/plantuml/issues/2345)
  - [🐛 improve weekly resource percentages in Gantt diagram](https://github.com/plantuml/plantuml/issues/1670)
  - [🎨 use new `Stereogroup` in activity diagrams](https://github.com/plantuml/plantuml/issues/2681)
  - [⚗️ scale inlined data URI images with a safe ARGB destination type](https://github.com/plantuml/plantuml/issues/2745)
  - [🎉 publish `diagram_explain` tool to npm (v0.1.3)](https://www.npmjs.com/package/@plantuml/mcp-js/v/0.1.3)
  - [🐛 add a task list in Gantt diagrams https://github.com/plantuml/plantuml/issues/2750](https://github.com/plantuml/plantuml/issues/2750)
  - [👷 fix native-image crash decoding remote JPEG images (#2757)](https://github.com/plantuml/plantuml/commit/491c880f3c1d899172e372ecd4a6fb30b8b8eceb)
  - [✨ mcp-js version 0.2.0](https://github.com/plantuml/plantuml/commit/b12946933dd5ac672aedbc6e6ae0b5aa774465f9)
  - [🐛 add a task list in Gantt diagrams](https://github.com/plantuml/plantuml/issues/2750)
  - [🔒 harden XmlFactories against XXE (CWE-611/CWE-776)](https://github.com/plantuml/plantuml/commit/630064dbf1546b311c4bceb54dc495d9081c1262)
  - [🐛 fix backward loop-back arrow and label placement across swimlanes](https://github.com/plantuml/plantuml/issues/2739)
  - [🐛 fix backward loop-back arrow and label placement across swimlanes](https://forum.plantuml.net/7516)
  - [✅ add vega tests about `!includesub`](https://github.com/plantuml/plantuml/commit/4cde76ea2856f3d97492b5625177114b4f0ee6e2)
  - [🐛 fix line-continuation `\` lost through `!includesub`](https://github.com/plantuml/plantuml/issues/2762)
  - [🍵 include plantuml source (`plantuml-src`) in SVG generated by js-plantuml](https://github.com/plantuml/plantuml/issues/2761)
  - [🐛 TikZ/LaTeX output: restore tex_system pragma and prevent xelatex hang (#2764)](https://github.com/plantuml/plantuml/commit/845afa26a7464cc764617e1a770b215b8a7f2005)
  - [🐛 fix invalid SVG copy/save on Firefox in js-plantuml editor](https://github.com/plantuml/plantuml/commit/d896ca67bfbeb51866ebaf9fd09d43512bccb483)
  - [🐛 fix gantt table issue](https://github.com/plantuml/plantuml/commit/b68eb39360903c5aa9bcbcdca700cbe1a6cefa73)
  - [⚗️ reduce SVG output size](https://github.com/plantuml/plantuml/commit/4f3a0dcc63b002990bc002fc15bd2adbf9c955ac)
  - [🔥 migrate default sequence diagram engine from Puma to Teoz](https://github.com/plantuml/plantuml/commit/7d1d71800d4ba67b1e21c38dc6c1f77ce35f5ae5)
  - [🐛 Fix #2277 NPE when using ELK (#2773)](https://github.com/plantuml/plantuml/commit/00eca4b280aa9b46084554c188923e629bc92654)
  - [📊 remove debug trace](https://github.com/plantuml/plantuml/commit/ff4c5d8ecaa637cc3f31d7b0771b07a75308074e)
  - [✨ tikz: auto-detect LaTeX engine (lualatex/xelatex/pdflatex), pragma now optional](https://github.com/plantuml/plantuml/commit/f02af54f97e55d9371cd727afe51ff55c09b0db7)
  - [🐛 add concurrent state support in Smetana](https://github.com/plantuml/plantuml/issues/2735)
  - [🐛 catch measurement failure in getDefaultStringBounder](https://github.com/plantuml/plantuml/issues/2764)
  - [🐛 allow destroy on all cases in sequence diagram](https://github.com/plantuml/plantuml/issues/2162)
  - [🐛 auto extend message text beyond its 2 participants in sequence diagram](https://github.com/plantuml/plantuml/issues/293)
  - [🐛 note left placed on the right side of sequence references](https://github.com/plantuml/plantuml/issues/1682)
  - [🐛 various Smetana fixes](https://github.com/plantuml/plantuml/commit/efde38dfc079a6c70a93f9258afa83be80756281)
  - [🐛 docker: fix render outputs being owned by root (#2777)](https://github.com/plantuml/plantuml/commit/3a90cc4eaccea267bee673d4add07d12d40b6187)
  - [🐛 allow URL or hyperlink on Activity diagram](https://github.com/plantuml/plantuml/issues/2754)
  - [🐛 entry point cannot be on root state](https://github.com/plantuml/plantuml/commit/aa65ce3999394bc2e5cae4bde488cb9f077f28a5)
  - [✅ add ascii tests](https://github.com/plantuml/plantuml/commit/ae7b054e2bca5b4d3f991178158bd2f9f8571b87)
  - [♻️ remove dead tile classes; dissolve TileParallel into a height-only pass](https://github.com/plantuml/plantuml/commit/9009f053ad37fed0cf07a037a276aa1de36fa54f)
  - [🐛 fix destroy cross not drawn after a past deactivation](https://github.com/plantuml/plantuml/issues/2776)
  - [🐛 Fix X-overlap between top-level `&`-parallel tiles (pixel + ASCII)](https://github.com/plantuml/plantuml/commit/9f52722c46ac2b5af55487927a845a2d93f0b893)
  - [🐾 fall back to Smetana when Graphviz/dot is unavailable](https://github.com/plantuml/plantuml/commit/a77b87e38d4b88ea6cbc95ccc69a865d4f3562f9)
  - [🐛 [Smetana] fix space between main component name and nested components](https://github.com/plantuml/plantuml/issues/1638)
  - [🐛 [Smetana] improve nested node](https://github.com/plantuml/plantuml/issues/1441)
  - [🐛 [Smetana] issues about arrow between nested elements](https://github.com/plantuml/plantuml/issues/2062)
  - [🐛 [Smetana] Improve group position (Issue using space)](https://github.com/plantuml/plantuml/issues/2789)
  - [🐛 fix newpage title ignored](https://github.com/plantuml/plantuml/issues/2784)
  - [🐛 fix self-message loops overflowing box/group frames](https://github.com/plantuml/plantuml/issues/2788)
  - [🐛 [Smetana] fill arrowheads of filled decorations fix https://github.com/plantuml/plantuml/issues/2795 (#2796)](https://github.com/plantuml/plantuml/issues/2795)
  - [🐛 improve skin error management](https://github.com/plantuml/plantuml/issues/2797)
  - [⚡️ Minify interactive SVG JS/CSS assets (#2023) (#2798)](https://github.com/plantuml/plantuml/commit/9a39b6bc1cec4a2f7785479fc35272759019816d)
  - [🐛 allow ':' as a single-character namespace separator](https://github.com/plantuml/plantuml/issues/2801)
  - [🍵 remove brotli from plantuml.js](https://github.com/plantuml/plantuml/issues/2805)
  - [📝 Add MCP Toplist rank badge (#2810)](https://github.com/plantuml/plantuml/commit/b586434dc8853fb67020e17f703d3e6fb30b8aff)
  - [🐛 Implement clock message arrow time projection (#2802)](https://github.com/plantuml/plantuml/commit/085c1231d0b4bdce1ff769788c269bf38de3ff4e)
  - [🐛 keep the participant following a group clear of its frame](https://github.com/plantuml/plantuml/issues/2788)
  - [🐛 fix notes on box-edge self-messages still overflowing box frames](https://github.com/plantuml/plantuml/issues/2791)
  - [🐛 fix various salt issues](https://github.com/plantuml/plantuml/issues/2730)
  - [🐛 !log silently disabled by default since #2594](https://github.com/plantuml/plantuml/commit/b94ce5cdfad4b406b605e6743b0597a15a3cd262)
  - [🐛 restore case-insensitive CLI flag matching](https://github.com/plantuml/plantuml/commit/fcee8ab62562e94ef36c2f618d3d3d96c83aea9f)
  - [🐛 fix invisible space reserved for composite state stereotypes](https://github.com/plantuml/plantuml/issues/2783)
  - [🐛 notes on class members lose their individual color](https://github.com/plantuml/plantuml/commit/0a08a9d6040e05afe750ddaf5155e84796ddc1eb)
  - [🐛 use java 21 for Docker in order to support OpenPDF](https://github.com/plantuml/plantuml/issues/2822)
  - [✨ js-plantuml: Persist URL sharing across deployments (#2827)](https://github.com/plantuml/plantuml/commit/3700a4287cab78e4c79b1df2ac0aad634fbff1da)
  - [✨ js-plantuml: Persist zoom and pan across deployments (#2830)](https://github.com/plantuml/plantuml/commit/b4ca3f0f93500405f83446695d819893c9e99e45)
  - [✨ js-plantuml: Open diagrams in live SVG and PNG tabs (#2831)](https://github.com/plantuml/plantuml/commit/54575fbd65661a1704a342984edfd2aecc3695c3)
  - [🐛 fix exit code 0 when GraphViz/dot crashes during rendering](https://github.com/plantuml/plantuml/commit/71a10a1466017df295596fe1f17360b3b81424ca)
  - [🐛 fix activated/deactivated sequence issues](https://github.com/plantuml/plantuml/issues/2729)

## V1.2026.6 (Jun 8, 2026)
  - [🍵 update standard library with JSON data and _examples_](https://github.com/plantuml/plantuml/commit/4d6e913e4389da30e04f492d2e73de003f3319c6)
  - [🍵 allow `%load_json` on TeaVM](https://github.com/plantuml/plantuml/issues/2724)
  - [🍵 fix `skinparam style strictuml` for TeaVM](https://github.com/plantuml/plantuml/commit/1f1c22f5b4c18383b9938d329e88125c4b72aef1)
  - [👷 fix release downstream jobs being silently skipped after upload](https://github.com/plantuml/plantuml/commit/3eb531a6c1dac2bb897fd3542607078d00a3d21f)
  - [🍵 allow `%get_all_theme` on TeaVM](https://github.com/plantuml/plantuml/issues/2725)
  - [🚧 preparation for hour/minute/second precision gantts](https://github.com/plantuml/plantuml/commit/06185256f2549d2aa6596d62fcb8d165d5975d31)
  - [🐛 fix gui regression](https://github.com/plantuml/plantuml/issues/2656)
  - [🍵 enable TeaVM JS build for the MIT license flavor (#2741)](https://github.com/plantuml/plantuml/commit/269cba38ff8c53e71ab32a0a632af47847a5ca76)
  - [👷 add MIT-flavored npm package assembly for @plantuml/core](https://github.com/plantuml/plantuml/commit/0043b6b7da2b74208296ce732be85b2bb2f8c0ca)
  - [✨ add Node/JS MCP server (plantuml-mcp-js) and MCP engine plumbing](https://github.com/plantuml/plantuml/commit/52a8090af30dcb7dd2569ac2c8259aedc7bce3ae)
  - [🐾 add `errorLine` in MCP `check_syntax`](https://github.com/plantuml/plantuml/commit/fb5d69df9c49992402c9f5d5f21a744b8731cc52)
  - [⚗️ add experimental diagram_explain to the JS MCP server and flesh out command explanations](https://github.com/plantuml/plantuml/commit/48c4b309ff500230740072096df0f4ec55283fb0)
  - [🐛 fix NPE in SVG nested diagram](https://github.com/plantuml/plantuml/issues/2728)


## V1.2026.5 (May 27, 2026)
  - [👷 improve Docker build](https://github.com/plantuml/plantuml/commit/10a5f40fd710da2fac2dd46247510e477d649019)
  - [♻️ clean StringBounder code](https://github.com/plantuml/plantuml/commit/0ed64d3f36af1a645bf9f7ce7dcf36a689bb1ca0)
  - [♻️ simplify dictionary loading for GraalVM](https://github.com/plantuml/plantuml/commit/d1d43c79073187c670423ccc3b46a78725edf1a5)
  - [👷 add native image builds (windows + linux amd64/arm64)](https://github.com/plantuml/plantuml/commit/9077e47239c19cc70935d624b45522ab99619fc8)
  - [🍵 add npmPackage Gradle task to publish JS engine to npm (#2715)](https://github.com/plantuml/plantuml/commit/4dada3774a3f32559c055e7518f3c9d652f968b3)
  - [👷 rename native images](https://github.com/plantuml/plantuml/commit/04fcf5ca7b1b7f67af9eae213086c8a39e11d801)
  - [🐛 add bitmap image support in PDF](https://github.com/plantuml/plantuml/commit/6a8578b1fa7431e218ad90bd6df96b774aeb0c50)
  - [👷 add native image builds (macOS)](https://github.com/plantuml/plantuml/commit/b2edbe93c2834c59b2c10883077abd9cc17bbe49)
  - [🔧 add config file for GraalVM build](https://github.com/plantuml/plantuml/commit/95c13c56e69305fc3522c0dc78a122442c1c40b9)
  - [📦️ add examples in standard library](https://github.com/plantuml/plantuml/commit/830b6e4ec3c601b232facc6036634a057a7dea20)
  - [🐛 fix HorizontalAlignment Right being ignored with MinimumWidth (#2717)](https://github.com/plantuml/plantuml/commit/f609859e3209e4e4c4a168fd5ed7913f1ca06a9a)
  - [🐛 accept decimal period, pulse and offset for timing clock (#2714)](https://github.com/plantuml/plantuml/issues/2711)
  - [👷 Fix 32-bit build failure caused by hardcoded JVM heap size (#2721)](https://github.com/plantuml/plantuml/commit/55b6a751bf935d85bcd02d279bac3226277f247f)
  - [📦️ update standard library](https://github.com/plantuml/plantuml/commit/711fb8019dcdb71334e55c67c4af04b86be4ce70)


## V1.2026.4 (May 20, 2026)
  - [♻️ use `UBrex` in Gantt diagram parsing](https://github.com/plantuml/plantuml/commit/4f0370800608acced36ac38d79335cbed87290cb)
  - [🍵 revert to TeaVM `0.13.1`](http://github.com/plantuml/plantuml/issues/2685#issuecomment-4415055785)
  - [🐛 fix(svg-parser): support space-separated coordinates in polygon/polyline sprites (#2692)](https://github.com/plantuml/plantuml/commit/5e9bc7e67aba8b973feb0c473b733452ca3d4342)
  - [🐛 fix '!' separator not recognized in class relation identifiers](https://github.com/plantuml/plantuml/issues/2685)
  - [🐛 improve CSS style for state diagrams](https://github.com/plantuml/plantuml/issues/2681)
  - [🍵 add support of OpenIconic icons in TeaVM](https://github.com/plantuml/plantuml/commit/ff7a693e32e3328691772a72555933f81247164c)
  - [🐛 improve unique id for SVG group elements](https://github.com/plantuml/plantuml/issues/2080#issuecomment-4449493249)
  - [✅ fix Vega tests with class drawing](https://github.com/plantuml/plantuml/commit/6737cc17eef967fc3ea0c4f0a6d995e7f63c2212)
  - [🍵 fix SVG document background color](https://github.com/plantuml/plantuml/issues/2527#issuecomment-4449429374)
  - [🐛 color specific days on gantt diagram](https://github.com/plantuml/plantuml/issues/2276)
  - [🍵 Add dark mode toggle and "Copy as bitmap" button to the Playground](https://github.com/plantuml/plantuml/commit/8385d71dbfc7108d5a0099125cb427483334a900)
  - [✨ online style in state diagram](https://github.com/plantuml/plantuml/commit/141ab7624ab6ce681ea5a3585694997ecce57e60)
  - [✅ vega: add SVG test (for `id`, `option`, and move `interaction`) (#2705)](https://github.com/plantuml/plantuml/commit/f355dabd2d4305015e54a1cda97cc12ceac450f6)
  - [🐛 manage CSS for empty description states](https://github.com/plantuml/plantuml/issues/2681#issuecomment-4462057594)
  - [🐛 improve SVG arrow drawing](https://github.com/plantuml/plantuml/issues/2706)
  - [🍵 playground: right-click menu to copy as bitmap or SVG](https://github.com/plantuml/plantuml/commit/c21e607ee4ed36fb9a7d637f2d8aee90d0717d5b)
  - [💥 Replace Batik-based PDF backend with native OpenPDF backend](https://github.com/plantuml/plantuml/commit/33edca6fd81f7c502c4225891a609541e14c13a0)
  - [✨ add new `INTERNET_WITH_DOTSVG` security profile](https://github.com/plantuml/plantuml/issues/2495)
  - [🐛 Improve dark mode (fontcolor) for activity spot or state history](https://github.com/plantuml/plantuml/issues/2704)
  - [✨ Allow CSS style on single line (#2713)](https://github.com/plantuml/plantuml/commit/e1928039f9f5e3d4377554364b9d44f690a8742c)

## V1.2026.3 (May 8, 2026)
  - [♻️ improve unsupported diagrams](https://github.com/plantuml/plantuml/issues/2598)
  - [🖼️ [Timing] improve constraint arrowhead](https://github.com/plantuml/plantuml/issues/2484)
  - [🐛 fix quoted URL misinterpreted in YAML](https://github.com/plantuml/plantuml/issues/2585)
  - [🐛 fix incorrect Japanese translations in i18n properties (#2604)](https://github.com/plantuml/plantuml/commit/2951ead177727dd972db5cdaf995fd17e8e2954f)
  - [🐾 Rename i18n property keys from `ebnf.*` to `regex.*` (#2605)](https://github.com/plantuml/plantuml/commit/091917127ec14734b45d1530c752a01fdef30fd9)
  - [✨ Improvements to the JS editor (#2609)](https://plantuml.github.io/plantuml/js-plantuml/)
  - [✨ add Base64 sprites](https://github.com/plantuml/plantuml/commit/be1159d1725ffb50f64b40bce2eeac148a977e03)
  - [✨ add MD5 sprites](https://github.com/plantuml/plantuml/commit/58f624fc03cb282dcc66ba505c0bebd6194ea9d2)
  - [⚗️ Hotfix ubrex Creole implementation in TeaVM build by replacing unicode at build time with inline `String.valueOf` (#2616)](https://github.com/konsoletyper/teavm/issues/1168)
  - [🐾 restore `svg` output for DOT diagram in `UNSECURE` mode](https://github.com/plantuml/plantuml/commit/2f49d7dab62b7122481a34d725e80edf0e3d005b)
  - [📊 detect misuse of `@startuml` for DOT or DITAA diagrams and print a helpful error](https://github.com/plantuml/plantuml/commit/d63fd38f94f51cf5f6040dabc183018fce1f2a08)
  - [🐾 spelling corrections](https://github.com/plantuml/plantuml/discussions/2614)
  - [🍵 fix text rotation](https://github.com/plantuml/plantuml/issues/2530)
  - [📊 detect misuse of `@startuml` for network diagrams and print a helpful error](https://github.com/plantuml/plantuml/issues/2603)
  - [🐾 fix sax parser issue with MD5 sprites](https://github.com/plantuml/plantuml/commit/207e2d98a9ee7f9c0fbe80a038e06099e21c98ea)
  - [🐛 fix NullPointerException in gantt diagram](https://github.com/plantuml/plantuml/issues/2633)
  - [✨ Two new features for WBS diagrams (#2627)](https://github.com/plantuml/plantuml/commit/fd9aeabc7f251ab6db6db82877616959dd90912c)
  - [✨ [Chart] Improve chart diagram (allow `x-axis` and `y-axis`, space before keyword, space at the end) (#2634)](https://github.com/plantuml/plantuml/commit/3b70e4539975678538ca5e612ee2d68b3393aacb)
  - [✨ change `AutoWidth true` to `width auto` in WBS diagrams](https://github.com/plantuml/plantuml/pull/2627)
  - [🐛 Bar Charts: Added Min and Max functions to prevent bars from being drawn outside of the plot (#2639)](https://github.com/plantuml/plantuml/issues/2617)
  - [🔒 disable access to external entities in XML parsing](https://github.com/plantuml/plantuml/commit/782197ecb9b8b7284c8fc55a0fb63d33c17051eb)
  - [📝 Add SonarQube Cloud badge to README](https://github.com/plantuml/plantuml/commit/6b2d1c8c55781482ae60bd6a29bd60817b9669fa)
  - [✨ [Packetdiag] add `same_height` param + center labels vertically (#2643)](https://github.com/plantuml/plantuml/commit/52a3526353cadd1089f10b369ff69e3329077eb5)
  - [✅ add special crash diagram for testing](https://github.com/plantuml/plantuml/commit/9f2c7f6d9f44a236cc10b2b80ca1fc01154f105e)
  - [🐛 component border color for ELK](https://github.com/plantuml/plantuml/issues/2020)
  - [📝 update UBrex documentation](https://github.com/plantuml/plantuml/commit/8a16cbdde3a5c271f6cd8a04680b10ee82c6df82)
  - [🐾 slight change in UBrex syntax](https://github.com/plantuml/plantuml/commit/bec149560144c62c8f806a45350dec2d271dad16)
  - [🍵 fix dash issue](https://github.com/plantuml/plantuml/issues/2527#issuecomment-4231055805)
  - [🍵 fix overlapping issue](https://github.com/plantuml/plantuml/issues/2527#issuecomment-4231188329)
  - [🐛(gantt): fix working day calculation for milestone after start (#2657)](https://github.com/plantuml/plantuml/issues/2394)
  - [✨ read MaximumWidth style property for arrow message wrapping (#2660) (#2661)](https://github.com/plantuml/plantuml/commit/4b4862509b396ace8bbb868d3cd8b87274440daa)
  - [🍵 fix gantt i18n](https://github.com/plantuml/plantuml/issues/2527)
  - [♻️ refactoring about padding](https://github.com/plantuml/plantuml/issues/2622)
  - [🐛 fix NPE on `note left` with `groupInheritance`](https://github.com/plantuml/plantuml/issues/866#issuecomment-4276754435)
  - [🐛 use CSS instead of skinparam for `margin` and `padding`](https://github.com/plantuml/plantuml/issues/2622)
  - [🐛 ignore `!pragma` and `skinparam` in listopeniconic and others](https://github.com/plantuml/plantuml/issues/2676)
  - [🐛 make `%date` deterministic across time zones (#2674)](https://github.com/plantuml/plantuml/issues/2674)
  - [🐾 add `--null` flag for performance test](https://github.com/plantuml/plantuml/commit/f823a16ddc547577e48a26df55a250c81574f288)
  - [🐛 add padding for `Object` thought CSS](https://github.com/plantuml/plantuml/issues/2622)
  - [✨ add `--loop` option for performance tests](https://github.com/plantuml/plantuml/commit/fd6d982863e3d6494f19499328687a89a963842a)
  - [🐛 fix gantt today highlight using system timezone instead of UTC (#688) (#2688)](https://github.com/plantuml/plantuml/issues/688)
  - [🖼️ migrate `skinparam ParticipantPadding/Padding` to CSS style in themes](https://github.com/plantuml/plantuml/commit/d79fb003694b837ca83c8b829e6ae94ca8869105)
  - [🐛 render `{0,N}` quantifier with the missing zero path](https://github.com/plantuml/plantuml/issues/2687)
  - [🔥 remove Pragma from SvgOption](https://github.com/plantuml/plantuml/issues/2683)
  - [🐛 EBNF "`0 *`" generates a zero path](https://github.com/plantuml/plantuml/issues/2689)
  - [🍵 standardize SVG output (group attributes)](https://github.com/plantuml/plantuml/issues/2683)
