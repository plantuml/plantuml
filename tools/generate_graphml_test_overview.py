...
##############
#  This script analyses the test cases of the graphML export extension and creates an overview markdown
#  for more details see /plantuml/test/nonreg/graphml/docs/readme.md
