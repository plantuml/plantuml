...
| `workflow_config`                  | Central config gate: computes flags & version from event context | Sets outputs: `do_release`, `do_snapshot_release`, `do_javadoc`, `do_test_linux`, `do_test_windows`                          | —                                                  | —                                                           |
