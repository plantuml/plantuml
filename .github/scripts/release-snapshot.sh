...
ln -s "../libs/plantuml-mit-${RELEASE_VERSION}.jar"              "${RELEASE_DIR}/plantuml-mit-SNAPSHOT.jar"
ln -s "../libs/plantuml-mit-${RELEASE_VERSION}-sources.jar"      "${RELEASE_DIR}/plantuml-mit-SNAPSHOT-sources.jar"
