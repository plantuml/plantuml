...
cp "plantuml-eclipse/repository/target/repository/plantuml-epl-${RELEASE_VERSION}-eclipse-update-site.zip" "github_release/plantuml-epl-${RELEASE_VERSION}-eclipse-update-site.zip"
