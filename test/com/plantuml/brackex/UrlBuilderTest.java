...
public class UrlBuilderTest {
	...
	public static BracketedExpression buildPart(String... parts) {
		final StringBuilder sb = new StringBuilder();
		for (String s : parts)
			sb.append(s);

		return BracketedExpression.build(sb.toString());
	}
	...
	public void testTooltip() {
		...
		BracketedExpression sQuoted = buildPart(parts);
	...
	public void test_S_QUOTED() {
		...
		String[] parts = { "[[ 〇*〴s", //
				...
				"〇?〘 〴s 「〤〴s{}[]」  〇*「〤[]」 〙", //
				"〇*〴s  ]]" };
		BracketedExpression cut = buildPart(parts);
