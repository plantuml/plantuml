...
public class RangeTest {
	...
	@Test
	public void test2() {
		BracketedExpression cut = BracketedExpression.build("「〤〴d」");
		assertEquals("h", cut.match(TextNavigator.build("h")).getAcceptedMatch());
	}
	...
	@Test
	public void test3() {
		BracketedExpression cut = BracketedExpression.build("「〤h」");
	...
	@Test
	public void test4() {
		BracketedExpression cut = BracketedExpression.build("「〤p」");
		assertEquals("h", cut.match(TextNavigator.build("h")).getAcceptedMatch());
	}
