...
public class WBSDiagramFactory extends PSystemCommandFactory {
	...
	@Override
	public WBSDiagram createEmptyDiagram(UmlSource source, Map<String, String> skinMap, ConfigurationStore<OptionKey> option) {
		return new WBSDiagram(source, option);
	}
