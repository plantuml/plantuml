...
public class ChenEerDiagramFactory extends PSystemCommandFactory {
	...
	@Override
	public AbstractPSystem createEmptyDiagram(UmlSource source, Map<String, String> skinMap, ProcessingArtifact preprocessing) {
		return new ChenEerDiagram(source, skinMap, preprocessing);
	}
