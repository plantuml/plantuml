...
import net.sourceforge.plantuml.tim.stdlib.GetStdlib;
...
public class TContext {
	...
	private StringLocated[] applyFunctionsAndVariablesInternal(TMemory memory, StringLocated located)
		...
		if (JawsFlags.USE_BLOCK_E1_IN_NEWLINE_FUNCTION && result.contains("\n"))
	...
	private String getFunctionNameAt(String s, int pos) {
		if (JawsFlags.USE_BLOCK_E1_IN_NEWLINE_FUNCTION == false) {
