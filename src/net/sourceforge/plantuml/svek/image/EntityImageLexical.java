...
public class EntityImageLexical extends AbstractEntityImage  {
	final private TextBlock name;
	final private TextBlock tag;
	final private TextBlock stereo;
	final private Url url;

	public EntityImageLexical(ILeaf entity, ISkinParam skinParam) {
		...
		this.tag = new BoxedCharacter('X', stereotype.getRadius(),
