...
final public class CommandLinkLollipop extends SingleLineCommand2<AbstractClassOrObjectDiagram> {
	...
	protected CommandExecutionResult executeArg(AbstractClassOrObjectDiagram diagram, LineLocation location,
		...
		if (arg.get("LOL_THEN_ENT", 1) == null) {
			...
			cl2 = diagram.reallyCreateLeaf(idNewLong, Display.getWithNewlines(diagram.legacyReplaceBackslashNByNewline(), ent2), type, null);
			normalEntity = cl1;
...
//			normalEntity = cl1;
			...
			cl1 = diagram.reallyCreateLeaf(idNewLong, Display.getWithNewlines(diagram.legacyReplaceBackslashNByNewline(), ent1), type, null);
			normalEntity = cl2;
		}
		...
		final LinkArg linkArg = LinkArg.build(Display.getWithNewlines(diagram.legacyReplaceBackslashNByNewline(), labelLink), length,
