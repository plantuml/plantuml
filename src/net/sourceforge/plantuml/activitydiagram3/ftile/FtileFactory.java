...
public interface FtileFactory {
    ...
    Ftile spot(Swimlane swimlane, String spot);

    Ftile activity(Display label, Swimlane swimlane, BoxStyle style, Colors colors);
    ...
    Ftile repeat(Swimlane swimlane, Swimlane swimlaneOut, Display startLabel, Ftile repeat, Display test,
			Display yes, Display out, HtmlColor color, LinkRendering backRepeatLinkRendering, Ftile backward,
			boolean noOut);

    Ftile createWhile(Swimlane swimlane, Ftile whileBlock, Display test, Display yes, Display out,
                      LinkRendering afterEndwhile, HtmlColor color, Instruction specialOut);

    Ftile createIf(Swimlane swimlane, List<Branch> thens, Branch elseBranch, LinkRendering afterEndwhile,
                   LinkRendering topInlinkRendering);

    Ftile createParallel(Swimlane swimlane, List<Ftile> all, ForkStyle style, String label);

    Ftile createGroup(Ftile list, Display name, HtmlColor backColor, HtmlColor titleColor, PositionedNote note,
