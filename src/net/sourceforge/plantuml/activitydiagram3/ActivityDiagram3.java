...
public class ActivityDiagram3 extends UmlDiagram {
    ...
    protected ImageData exportDiagramInternal(OutputStream os, int index, FileFormatOption fileFormatOption)
        ...
        final ImageBuilder imageBuilder = new ImageBuilder(skinParam.getColorMapper(), dpiFactor,
                getSkinParam().getBackgroundColor(), fileFormatOption.isWithMetadata() ? getMetadata() : null,
                getWarningOrError(), margin, margin, getAnimation(), getSkinParam().handwritten());
    ...
    // }
    //
    // private final HtmlColor getFontColor(FontParam fontParam, Stereotype
    // stereotype2) {
    // final ISkinParam skinParam = getSkinParam();
    ...
    @Override
    protected ImageData exportDiagramInternal(List<ComponentDisplayInfo> displayComponents, OutputStream os, int index,
