...
public class ST_tedge_t extends UnsupportedStructAndPtr {
	...
	// private final ST_pointnlink_t.Amp openiconic;
	//
	// Singleton(ST_pointnlink_t.Amp openiconic) {
	...
	// return super.toString() + " " + openiconic + " " + openiconic.getStruct();
	// }
	//
	// @Override
	...
	// System.err.println("other2.openiconic=" + other2.openiconic);
