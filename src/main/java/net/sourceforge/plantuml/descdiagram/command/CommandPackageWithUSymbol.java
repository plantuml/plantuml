		...
		return RegexConcat.build(CommandPackageWithUSymbol.class.getName(), RegexLeaf.start(), //
				...
				new RegexOr(//
						new RegexConcat( //
								...
								new RegexLeaf("as"), //
								RegexLeaf.spaceOneOrMore(), new RegexLeaf(1, "CODE1", "([^#%s{}]+)") //
						), //
						new RegexConcat( //
								PatternCacheStrategy.CACHE, //
								...
								RegexLeaf.spaceZeroOrMore(), //
								new RegexLeaf("as"), //
								RegexLeaf.spaceOneOrMore(), new RegexLeaf(1, "DISPLAY2", "([%g].+?[%g])") //
						), //
						new RegexConcat( //
								PatternCacheStrategy.CACHE, //
								...
								RegexLeaf.spaceZeroOrMore(), //
								new RegexLeaf("as"), //
								RegexLeaf.spaceOneOrMore(), new RegexLeaf(1, "CODE3", "([^#%s{}%g]+)") //
						), //
