...
import net.sourceforge.plantuml.gantt.timescale.TimeScaleCompressed;
import net.sourceforge.plantuml.gantt.timescale.TimeScaleDaily;
import net.sourceforge.plantuml.gantt.timescale.TimeScaleDailyHideClosed;
import net.sourceforge.plantuml.gantt.timescale.TimeScaleWink;
import net.sourceforge.plantuml.gantt.timescale.VariantTimeScale;

public class TimeHeaderFactory {

	private static final double closeFactor = 0.2;
	private static final double dayWidth = 120;
	...
	private TimeScale createDailyScale() {
		...
		return new TimeScaleDaily(getCellWidth(), getStart(), getEffectiveScale(), timeBounds.getPrintStart());
	}

	private TimeScale createCompressedScale() {
		return new TimeScaleCompressed(getCellWidth(), getStart(), getEffectiveScale(), timeBounds.getPrintStart());
	}
