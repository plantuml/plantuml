...
import net.sourceforge.plantuml.gantt.ngm.math.PiecewiseConstantWeekday;

/**
 * Represents the resource allocation applied to a task over time.
 *
 * <p>
 * An allocation describes how much workforce capacity is assigned to a task at
 * any given instant. Unlike a simple constant fraction, an allocation can vary
 * over time, which is modeled using a {@link PiecewiseConstant} function.
 *
 * <p>
 * The allocation value at any instant is expressed as a {@link Fraction},
 ...
 * <li><code>0</code> at certain times — No work during weekends, holidays, or
 * outside working hours</li>
 * </ul>
 *
 * <h3>Time-varying allocation</h3>
 * <p>
 * By wrapping a {@link PiecewiseConstant}, this class can represent complex
 ...
 *
 * <p>
 * The {@link LoadIntegrator} uses this allocation function to compute how long
 * a fixed-effort task will take, by integrating the allocation over time until
 * the required effort is consumed.
 *
...
public class NGMAllocation {
	 ...
	 * 
	 * <p>
	 * At any given {@link LocalDateTime}, this function returns a {@link Fraction}
	 * representing the effective FTE allocation at that instant.
	 * 
	 * <p>
	 * A value of {@code Fraction.ONE} means full-time work. A value of
	 * {@code Fraction.ZERO} means no work (e.g., weekend, holiday, night).
	 */
	 ...
	 *
	 * @param loadFunction the piecewise constant function defining the allocation
	 *                     over time
	 */
	 ...
	 *
	 * <p>
	 * This is the most flexible factory method, allowing any
	 * {@link PiecewiseConstant} to define the allocation pattern.
	 *
	 * @param loadFunction the piecewise constant function defining allocation over
	 *                     time
	 ...
	 *
	 * <p>
	 * This represents one person working full-time with no calendar constraints.
	 * Work can happen 24/7. Useful for simple calculations or as a baseline before
	 * applying calendar constraints via {@code Combiner.product()}.
	 *
	 ...
	 * {@link net.sourceforge.plantuml.gantt.ngm.math.LoadIntegrator} to compute
	 * task durations based on effort and allocation.
	 *
