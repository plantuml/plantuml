 ...
 *
 * <p>
 * The NGM model is intentionally kept independent from the rest of PlantUML: it
 * must not depend on rendering, diagram classes, or the legacy Gantt
 * implementation. The goal is to have a clean, reusable scheduling core that
 * can later be integrated or tested in isolation.
 * </p>
 */
