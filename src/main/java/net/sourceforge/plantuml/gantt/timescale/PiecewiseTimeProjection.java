...
public class PiecewiseTimeProjection {

	private final PixelInstant start;
	private final PixelInstant end;

	public PiecewiseTimeProjection(PixelInstant start, PixelInstant end) {
		this.start = start;
		this.end = end;
	}

	public PixelInstant getStart() {
		return start;
	}
