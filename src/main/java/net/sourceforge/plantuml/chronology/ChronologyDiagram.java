...
//	}
	...
	public ChronologyDiagram(PathSystem pathSystem, UmlSource source, PreprocessingArtifact preprocessing) {
		super(pathSystem, source, UmlDiagramType.CHRONOLOGY, null, preprocessing);
	}
