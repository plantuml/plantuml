 ...
 * {@link StyleAtomTrie}, so {@link #findMatching(StyleQuery)} only ever visits
...
public final class StyleIndex {
	 ...
	 * "@media (dark) { root { FontColor white } }" share the exact same {@link StyleQuery}
	...
	/**
	 * Every loaded style whose query is a subset of {@code query}'s, in the order they were
	 * loaded or muted in.
	 */
