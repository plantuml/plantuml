 ...
 *
 * This walk follows the {@link MergedStyleNode} tree top to bottom, accumulating a
 * {@link StyleQuery} along the path, and emits one {@link Style} per node that has properties,
 * converting each {@link PrioritizedValue} to a {@link Value} on the way. Two legacy behaviors
 * matter here and are handled explicitly:
 * <ul>
 ...
 * {@code Context#push}'s {@code SName.retrieve(s) == null -> addStereotype(s)} fallback.</li>
 * </ul>
 */
