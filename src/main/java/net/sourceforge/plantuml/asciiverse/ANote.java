...
// asciiart.UmlCharAreaImpl.drawNoteSimple()/drawNoteSimpleUnicode() (that
// package is slated for removal): ASCII cuts a "!."/"|_\"
...
public final class ANote implements AsciiBlock {
	...
	// `width = max(5, textWidth + 2)`, `height =
	...
	public void asciiDraw(InfinitePlan plan) {
		...
		// (column, row), it's read off whatever `plan` this block is
		...
		// asciiDimension()) can build an ANote with nothing but the
