...
public class FlowDiagram extends UmlDiagram implements TextBlock {
	...
	public FlowDiagram(PathSystem pathSystem, UmlSource source, PreprocessingArtifact preprocessing) {
		super(pathSystem, source, UmlDiagramType.FLOW, null, preprocessing);
	}
