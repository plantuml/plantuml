...
public class ColorResolver {
	...
	public HColor getDefaultColor() {
		...
		return forcedColor == null ? fontColor : forcedColor;
	}
	...
	public HColor getTrueColor(String code) {
		...
		if (forcedColor.isGray())
			return result.asMonochrome();
		
		return result.asMonochrome(forcedColor, grayLevelRange.getMinGrayLevel(), grayLevelRange.getMaxGrayLevel());
	}
