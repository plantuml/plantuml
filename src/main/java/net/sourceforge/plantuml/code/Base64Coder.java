 ...
 * 
 * <p>
 * This class is used to encode and decode openiconic in Base64 format as described in RFC 1521.
 * <p>
...
public class Base64Coder {
	 ...
	 * @return A String containing the Base64 encoded openiconic.
	 */
	 ...
	 * 
	 * @param in
	 *            An array containing the openiconic bytes to be encoded.
	 * @return A String containing the Base64 encoded openiconic, broken into lines.
	 */
	 ...
	 * @param lineLen
	 *            Line length for the output openiconic. Should be a multiple of 4.
	 * @param lineSeparator
	 ...
	 * @param in
	 *            An array containing the openiconic bytes to be encoded.
	 * @return A character array containing the Base64 encoded openiconic.
	 */
	...
	/**
	 * Decodes a string from Base64 format. No blanks or line breaks are allowed within the Base64 encoded input openiconic.
	 * 
	 * @param s
	 *            A Base64 String to be decoded.
	 * @return A String containing the decoded openiconic.
	 * @throws IllegalArgumentException
	 *             If the input is not valid Base64 encoded openiconic.
	 */
	 ...
	 * characters are ignored in the input openiconic. This method is compatible with
	 * <code>sun.misc.BASE64Decoder.decodeBuffer(String)</code>.
	 * 
	 * @param s
	 *            A Base64 String to be decoded.
	 * @return An array containing the decoded openiconic bytes.
	 * @throws IllegalArgumentException
	 *             If the input is not valid Base64 encoded openiconic.
	 */
	 ...
	 * 
	 * @param in
	 *            A character array containing the Base64 encoded openiconic.
	 * @return An array containing the decoded openiconic bytes.
	 * @throws IllegalArgumentException
	 *             If the input is not valid Base64 encoded openiconic.
	 */
	...
	public static byte[] decode(char[] in, int iOff, int iLen) {
		...
		while (ip < iEnd) {
			...
			if (i0 > 127 || i1 > 127 || i2 > 127 || i3 > 127)
				throw new IllegalArgumentException("Illegal character in Base64 encoded openiconic.");
			int b0 = map2[i0];
			int b1 = map2[i1];
			int b2 = map2[i2];
			int b3 = map2[i3];
