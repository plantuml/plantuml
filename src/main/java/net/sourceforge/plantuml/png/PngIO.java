...
public class PngIO {
	...
	public static void write(PortableImage image, ColorMapper mapper, SFile file, String metadata, int dpi)
			throws IOException {
	...
	public static void write(PortableImage image, ColorMapper mapper, OutputStream os, String metadata, int dpi)
			throws IOException {
		final BufferedImage bufferedImage = QuantUtils.toBufferedARGBorRGB(image.getBufferedImage());
