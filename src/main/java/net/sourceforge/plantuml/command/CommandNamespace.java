...
public class CommandNamespace extends SingleLineCommand2<ClassDiagram> {
	...
	private static IRegex getRegexConcat() {
		return RegexConcat.build(CommandNamespace.class.getName(), RegexLeaf.start(), //
				...
				new RegexLeaf(1, "NAME", NAMESPACE_REGEX), //
	...
	protected CommandExecutionResult executeArg(ClassDiagram diagram, LineLocation location, RegexResult arg, ParserPass currentPass)
		...
		final CommandExecutionResult status = diagram.gotoGroup(location, quark, Display.getWithNewlines(diagram.getPragma(), quark.getName()),
