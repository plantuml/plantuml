...
public abstract class PSystemAbstractFactory implements PSystemFactory {
	...
	final protected PSystemError buildEmptyError(UmlSource source, StringLocated lineLocation,
	...
	final protected PSystemError buildExecutionError(UmlSource source, String stringError, StringLocated lineLocation,
			List<StringLocated> trace, PreprocessingArtifact preprocessing) {
