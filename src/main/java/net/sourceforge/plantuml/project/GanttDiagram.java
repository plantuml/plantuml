...
public class GanttDiagram extends TitledDiagram implements ToTaskDraw, WithSprite, GanttStyle {
	...
	private TimePoint min = TimePoint.epoch();
	...
	private ResourceDraw buildResourceDraw(GanttDiagram gantt, Resource res, TimeScale timeScale, double y, TimePoint min,
			TimePoint max) {
...
//			return new ResourceDrawHistogram(gantt, res, timeScale, y, min, max);
	...
	public void setProjectStartingDate(TimePoint start) {
