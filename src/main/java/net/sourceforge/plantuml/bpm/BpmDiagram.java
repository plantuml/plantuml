...
public class BpmDiagram extends UmlDiagram {
	...
	public BpmDiagram(PathSystem pathSystem, UmlSource source, PreprocessingArtifact preprocessing) {
		super(pathSystem, source, UmlDiagramType.BPM, null, preprocessing);
	}
