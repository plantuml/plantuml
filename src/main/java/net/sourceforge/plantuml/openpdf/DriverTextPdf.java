...
public class DriverTextPdf implements UDriver<UText, PdfGraphics> {
...
//	}
	...
	public void draw(UText shape, double x, double y, ColorMapper mapper, UParam param, PdfGraphics pdf) {
		...
		final UFont ufont = fontConfiguration.getFont();
...
//
		...
		pdf.setFillColor(textColor.toColor(mapper).toAwtColor());
		final BaseFont baseFont = StringBounderOpenPdf.resolveFont(fontConfiguration.getFont());

		pdf.pdfText(text, x, y, baseFont, ufont.getSize());
