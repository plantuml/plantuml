...
public class MindMapDiagramFactory extends PSystemCommandFactory {
	...
	@Override
	public MindMapDiagram createEmptyDiagram(PathSystem pathSystem, UmlSource source, Previous previous, PreprocessingArtifact preprocessing) {
		return new MindMapDiagram(pathSystem, source, preprocessing);
	}
