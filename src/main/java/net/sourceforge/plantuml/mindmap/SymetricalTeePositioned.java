...
public class SymetricalTeePositioned {
	...
	public XLine2D getSegmentA1() {
		return new XLine2D(0, y - tee.getThickness1() / 2, tee.getElongation1(), y - tee.getThickness1() / 2);
	}

	public XLine2D getSegmentB1() {
		return new XLine2D(0, y + tee.getThickness1() / 2, tee.getElongation1(), y + tee.getThickness1() / 2);
	}

	public XLine2D getSegmentA2() {
		return new XLine2D(tee.getElongation1(), y - tee.getThickness2() / 2,
				tee.getElongation1() + tee.getElongation2(), y - tee.getThickness2() / 2);
	}

	public XLine2D getSegmentB2() {
		return new XLine2D(tee.getElongation1(), y + tee.getThickness2() / 2,
				tee.getElongation1() + tee.getElongation2(), y + tee.getThickness2() / 2);
	}
