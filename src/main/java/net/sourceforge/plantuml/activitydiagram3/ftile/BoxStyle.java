...
public abstract class BoxStyle {
	...
	// Shape: (=)
	public static final BoxStyle PLAIN = new BoxStylePlain(null, 0);
	...
	// Shape: >=>
	public static final BoxStyle UML_OBJECT_SIGNAL = new BoxStyleObjectSignal("objectSignal", 10);

	// Shape: |=<
	public static final BoxStyle UML_TRIGGER = new BoxStyleTrigger("trigger", 10);

	// Shape: |=>
	public static final BoxStyle UML_SEND_SIGNAL = new BoxStyleSendSignal("sendSignal", 10);

	// Shape: >=|
	public static final BoxStyle UML_ACCEPT_EVENT = new BoxStyleAcceptEvent("acceptEvent", 10);

	// Shape: X
	public static final BoxStyle UML_TIME_EVENT = new BoxStyleTimeEvent("timeEvent", 10);
...
class BoxStylePlain extends BoxStyle {
	...
	public BoxStylePlain(String stereotype, double shield) {
...
class BoxStyleInput extends BoxStyle {
	...
	public BoxStyleInput(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleOutput extends BoxStyle {
	...
	public BoxStyleOutput(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleProcedure extends BoxStyle {
	...
	public BoxStyleProcedure(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleLoad extends BoxStyle {
	...
	public BoxStyleLoad(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleSave extends BoxStyle {
	...
	public BoxStyleSave(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleContinuous extends BoxStyle {
	...
	public BoxStyleContinuous(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleTask extends BoxStyle {
	...
	public BoxStyleTask(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleObject extends BoxStyle {
	...
	public BoxStyleObject(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleObjectSignal extends BoxStyle {
	...
	public BoxStyleObjectSignal(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleTrigger extends BoxStyle {
	...
	public BoxStyleTrigger(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleSendSignal extends BoxStyle {
	...
	public BoxStyleSendSignal(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleAcceptEvent extends BoxStyle {
	...
	public BoxStyleAcceptEvent(String stereotype, double shield) {
		super(stereotype, shield);
	}
...
class BoxStyleTimeEvent extends BoxStyle {
	...
	public BoxStyleTimeEvent(String stereotype, double shield) {
		super(stereotype, shield);
	}
