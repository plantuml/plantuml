...
public class CommunicationTileSelfNoteLeft extends AbstractTile {
	...
	// still isn't reserved on the ASCII column solver -- same known gap as
	// every other note decorator.
	@Override
	...
	// ending just before the anchor column -- the same
