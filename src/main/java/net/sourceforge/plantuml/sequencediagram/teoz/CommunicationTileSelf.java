...
public class CommunicationTileSelf extends AbstractCommunicationTile {
	...
	// ---------------------------------------------------------------------
	// ASCII rendering (ASCIIVERSE.md §9.5's self-message to-do item).
	//
	// Idea copied from the legacy asciiart.ComponentTextSelfArrow (never its
	// code, which belongs to the doomed asciiart package, see ASCIIVERSE.md
	// §1/§9.1/§12): a small loop box sits to the side of the lifeline --
	//   ,----.
	//   |    |    label
	//   <----'
	...
	// reserves next to each lifeline (ASCIIVERSE.md §25), here reserved once
	...
	// collision to guard against (ASCIIVERSE.md §25's failure mode).
	...
	// AsciiBlockMarginLR already applies (ASCIIVERSE.md §25).
