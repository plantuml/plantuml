...
public class CommandChartOrientation extends SingleLineCommand2<ChartDiagram> {

	private static final Collection<String> FIRST_TOKENS = Arrays.asList("orientation");
	...
	protected CommandExecutionResult executeArg(ChartDiagram diagram, LineLocation location, RegexResult arg,
		...
		final String orientationStr = arg.get("ORIENTATION", 0);
