...
public class PanelsRectangle extends PanelsState {

	public PanelsRectangle(TimingRuler ruler, ISkinParam skinParam, List<TimingNote> notes, int suggestedHeight,
