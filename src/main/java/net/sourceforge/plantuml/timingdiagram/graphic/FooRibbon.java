...
public class FooRibbon extends AbstractFooRibbon {
	...
	public FooRibbon(TimingRuler ruler, ISkinParam skinParam, List<TimingNote> notes, int suggestedHeight, Style style,
	...
	protected void drawPentaA(UGraphic ug, double len, ChangeState change) {
		final PentaAShape shape = PentaAShape.create(len, getRibbonHeight(), getContextWithInitialColors(change));
		shape.drawU(ug);
	}
