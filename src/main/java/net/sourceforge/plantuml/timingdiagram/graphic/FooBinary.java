...
public class FooBinary implements PlayerPanels {
	...
	private final StyleSignature styleSignature;
	...
	final protected FontConfiguration getCommentFontConfiguration() {
		return FontConfiguration.create(skinParam, styleSignature.getMergedStyle(skinParam.getCurrentStyleBuilder()));
	}
