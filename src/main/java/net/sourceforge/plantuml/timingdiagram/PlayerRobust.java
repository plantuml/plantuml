...
import net.sourceforge.plantuml.timingdiagram.graphic.PanelsRobust;
...
public final class PlayerRobust extends AbstractStatePlayer {
	...
	public PlayerRobust(String full, ISkinParam skinParam, TimingRuler ruler, boolean compact, Stereotype stereotype,
		...
		super(full, skinParam, ruler, compact, stereotype, generalBackgroundColor, SName.robust, 2.5);
	}

	@Override
	protected Panels buildPlayerPanels() {
		final PanelsRobust result = new PanelsRobust(getRuler(), getSkinParam(), getStatesLabel().values(),
				getSuggestedHeight(), getStyle(), getConstraints());
