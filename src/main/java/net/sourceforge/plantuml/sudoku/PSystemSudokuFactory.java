...
public class PSystemSudokuFactory extends PSystemSingleLineFactory {
	...
	protected AbstractPSystem executeLine(PathSystem pathSystem, UmlSource source, String line, PreprocessingArtifact preprocessing) {
		...
		if (m.group(1) == null) 
			return new PSystemSudoku(pathSystem, source, null, preprocessing);
		
		return new PSystemSudoku(pathSystem, source, Long.parseLong(StringUtils.goLowerCase(m.group(1)), 36), preprocessing);
	}
