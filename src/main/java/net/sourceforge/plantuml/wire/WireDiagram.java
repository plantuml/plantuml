...
public class WireDiagram extends UmlDiagram {
	...
	public WireDiagram(PathSystem pathSystem, UmlSource source, PreprocessingArtifact preprocessing) {
		super(pathSystem, source, UmlDiagramType.WIRE, null, preprocessing);
	}
