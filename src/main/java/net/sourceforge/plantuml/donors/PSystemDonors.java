...
public class PSystemDonors extends PlainDiagram {
	...
	public PSystemDonors(PathSystem pathSystem, UmlSource source, PreprocessingArtifact preprocessing) {
	...
	public static PSystemDonors create(UmlSource source, PreprocessingArtifact preprocessing) {
		return new PSystemDonors(PathSystem.fetch(), source, preprocessing);
	}
