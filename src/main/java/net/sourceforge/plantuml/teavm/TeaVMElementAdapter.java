...
public class TeaVMElementAdapter implements IElement {
	// ::remove file when JAVA8

	private final Element wrapped;

	public TeaVMElementAdapter(Element wrapped) {
	...
	public void appendChild(IElement child) {
		final TeaVMElementAdapter other = (TeaVMElementAdapter) child;
