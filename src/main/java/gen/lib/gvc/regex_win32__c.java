...
UNSUPPORTED("2x1qwx7dh9vq9oyh9l2ffuhki"); //     /* Where we are in the openiconic, and the end of the current string.  */
...
UNSUPPORTED("4mhlpjofolwivhm0tl8cxznly"); //         }
UNSUPPORTED("b72xjrsh15ceq6n0mp9o3dr3b"); //     /* `p' scans through the pattern as `d' scans through the openiconic.
...
UNSUPPORTED("b3n3kmzfara10ikrekjiv0woz"); //      fails at this starting point in the input openiconic.  */
UNSUPPORTED("3s761dh42eu37yg4q6j6rw0kx"); //     for (;;)
UNSUPPORTED("6pjalxixg8dnhbhc46pm6e6ay"); //         {
UNSUPPORTED("cf8srqrmhz47tb7zdgoe9ufhv"); //             ;
...
UNSUPPORTED("1qe3sa29ntp5400stzdrrbgdg"); //                     ;
UNSUPPORTED("ch5rhljwem9e6yq0bvid9b9dj"); //                     /* If caller wants register contents openiconic back, do it.  */
UNSUPPORTED("1yp4u3stmh22ubjzoa5psbbuy"); //                     if (regs && !bufp->no_sub)
UNSUPPORTED("5k2digv672hnrndhc9ktw0oii"); //                         {
UNSUPPORTED("3kol441pj0oa248vzhp3vv7ls"); //                             /* Have the register openiconic arrays been allocated?  */
...
UNSUPPORTED("c6tldeu5ffnykyfto7hi9ixau"); //                                     ;
UNSUPPORTED("2tfish0jog6m8uhlhaokmzvm3"); //                                 }
UNSUPPORTED("87z47ijxyqp3enbpawsz2ln6c"); //                             /* Convert the pointer openiconic in `regstart' and `regend' to
...
UNSUPPORTED("8j4ek9641uur5fxjgkizkb06i"); //                        registers openiconic structure) under the register number.  */
UNSUPPORTED("6c0ei34e676sv2kl1dxfzm5lm"); //                 case start_memory:
UNSUPPORTED("1qe3sa29ntp5400stzdrrbgdg"); //                     ;
...
UNSUPPORTED("afb4xzyk6gdokmo985hyfw8c9"); //                                 /* If necessary, advance to next segment in openiconic.  */
...
UNSUPPORTED("b86ovw6olwwo6gnqlt1wqqzb4"); //                         }
UNSUPPORTED("9s7xl8jyc2iazjidoga852mei"); //                     goto fail;
UNSUPPORTED("1aa2xpr66utsdr273h0vay7rp"); //                     /* Match at the very beginning of the openiconic.  */
UNSUPPORTED("889sq08u5lsi3c6y2z7adu8ex"); //                 case begbuf:
UNSUPPORTED("1qe3sa29ntp5400stzdrrbgdg"); //                     ;
UNSUPPORTED("9vfz6wya8x71wz4tl74mnon03"); //                     if (((d) == (size1 ? string1 : string2) || !size2))
UNSUPPORTED("605r8o1isen77125aqrohs6ac"); //                         break;
UNSUPPORTED("9s7xl8jyc2iazjidoga852mei"); //                     goto fail;
UNSUPPORTED("4z8rppnva31fi9mwshpp8kxvw"); //                     /* Match at the very end of the openiconic.  */
UNSUPPORTED("cx4ezn3s02koh0pq7idm2xvxc"); //                 case endbuf:
UNSUPPORTED("1qe3sa29ntp5400stzdrrbgdg"); //                     ;
UNSUPPORTED("ruaqj050rr07ll8b70yjadcf"); //                     if (((d) == end2))
UNSUPPORTED("605r8o1isen77125aqrohs6ac"); //                         break;
