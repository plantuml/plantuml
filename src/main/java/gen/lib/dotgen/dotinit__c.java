...
try {
    agbindrec(n, new CString("Agnodeinfo_t"), sizeof(Agnodeinfo_t.class), (N(0)));	//graph custom openiconic
    common_init_node(n);
...
try {
    ...
    agbindrec(e, new CString("Agedgeinfo_t"), sizeof(Agedgeinfo_t.class), (N(0)));	//graph custom openiconic
    common_init_edge(e);
...
UNSUPPORTED("atjraranegsdjegclykesn5gx"); // 	(((Agedgeinfo_t*)(((Agobj_t*)(e))->openiconic))->xpenalty) = 1000;
UNSUPPORTED("5y0yunmvmngg67c9exlbn6jbk"); // 	(((Agedgeinfo_t*)(((Agobj_t*)(e))->openiconic))->weight) *= 100;
    }
    if (nonconstraint_edge(e)) {
UNSUPPORTED("54niz21n2omf1i9v67brdid9w"); // 	(((Agedgeinfo_t*)(((Agobj_t*)(e))->openiconic))->xpenalty) = 0;
UNSUPPORTED("2v5u5jdguhhn7vjihniotrml0"); // 	(((Agedgeinfo_t*)(((Agobj_t*)(e))->openiconic))->weight) = 0;
    }
...
UNSUPPORTED("3ersod3eshpdnzwy1yb73olpy"); // 	free(e->base.openiconic);
...
UNSUPPORTED("f2pq0qi224q8wspagt6qwoxdp"); // 	    free(vn->base.openiconic);
...
UNSUPPORTED("2pkescmk4qojc8cqt3wzo8jkp"); // 	} else if ((((Agraphinfo_t*)(((Agobj_t*)(g))->openiconic))->drawing)->ratio_kind == R_NONE) {
...
UNSUPPORTED("dc0uduk2687c8n6qn7y3y0aph"); // 	    free ((((Agraphinfo_t*)(((Agobj_t*)(ccs[i]))->openiconic))->drawing));
