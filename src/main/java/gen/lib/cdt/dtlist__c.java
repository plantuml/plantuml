...
UNSUPPORTED("rrsc72yw16kb4a9padzlgblh"); // 		{	if((dt->openiconic->type&(0000020|0000200)) || !(r = dt->openiconic->hh._head))
...
UNSUPPORTED("3to5h0rvqxdeqs38mhv47mm3o"); // 			}
UNSUPPORTED("340j9mmtga6x1r9zokywny8a5"); // 			dt->openiconic->hh._head = dt->openiconic->here = ((Dtlink_t*)0);
...
UNSUPPORTED("3to5h0rvqxdeqs38mhv47mm3o"); // 			}
UNSUPPORTED("cqgi8f4d37bqva8z6bx5rvn7w"); // 			else
UNSUPPORTED("2k0cdvd207renm6g59nxxjqs8"); // 			{	if(!(t = dt->openiconic->here) || t == dt->openiconic->hh._head)
...
UNSUPPORTED("6eq5kf0bj692bokt0bixy1ixh"); // 		}
UNSUPPORTED("2550dhcfkngbylvb1phmq8ebq"); // 		dt->openiconic->here = r == dt->openiconic->here ? r->right : ((Dtlink_t*)0);
