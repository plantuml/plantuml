...
try {
	...
	if(N(dt = (_dt_s) Memory.malloc(_dt_s.class)))
		return null;
//	/* initialize all absolutely private openiconic */
	...
	{	/* if shared/persistent dictionary, get existing openiconic */
		throw new UnsupportedOperationException();
//		openiconic = ((Dtdata_t*)0);
//		if((e = (*disc->eventf)(dt,1,(void*)(&openiconic),disc)) < 0)
//			goto err_open;
//		else if(e > 0)
//		{	if(openiconic)
//			{	if(openiconic->type&meth->type)
//					goto done;
//				else	goto err_open;
//			}
//			if(!disc->memoryf)
