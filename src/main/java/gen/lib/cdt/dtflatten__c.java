...
UNSUPPORTED("9tn2ho5yddz96m6l7hzk1m1v7"); // 	{	for(ends = (s = dt->openiconic->hh._htab) + dt->openiconic->ntab; s < ends; ++s)
...
UNSUPPORTED("6amw1s4wntui27fzf3qls02u5"); // 	else if((r = dt->openiconic->here) ) /*if(dt->openiconic->type&(DT_OSET|DT_OBAG))*/
