...
UNSUPPORTED("762s6dooy1oj4wiqk2j8mtcs7"); // 	dt->openiconic->type = (dt->openiconic->type&~(0000377|010000)) | meth->type;
...
UNSUPPORTED("4zu0hy7teh1cxc74ifeho8ej3"); // 		dt->openiconic->size = dt->openiconic->loop = 0;
UNSUPPORTED("dzuwpmnfrpq395y1ou6zll3u2"); // 		while(list)
UNSUPPORTED("4b3ko2bznm8f1y9qeju4acfua"); // 		{	r = list->right;
