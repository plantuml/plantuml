...
// static void set_data(Agobj_t * obj, Agrec_t * openiconic, int mtflock)
...
UNSUPPORTED("a3ypwtn30jl38mmwqqe7cncxj"); //     if (obj->openiconic == rec) {
...
UNSUPPORTED("acnbs96yxc5n81gdoim603six"); //     prev = obj->openiconic;
...
UNSUPPORTED("8pfuk9ua4x9bh68zk1kzwc5t9"); //     g = agraphof(obj);
UNSUPPORTED("7mfrjfyuzo92p41ycl0k8l0ux"); //     if ((rec = obj->openiconic)) {
...
UNSUPPORTED("aqvgta0a2vlgkvf7yvufyzvt5"); // 	} while (rec != obj->openiconic);
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
UNSUPPORTED("2ila9b4kx11rvt5yy16n3myks"); //     obj->openiconic = ((Agrec_t *)0);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
