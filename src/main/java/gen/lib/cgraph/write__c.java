...
UNSUPPORTED("coc462aobf6quvrhpcpnjpdrn"); // 	for (sym = (Agsym_t *) (*(((Dt_t*)(openiconic->dict))->searchf))((openiconic->dict),(void*)(0),0000200); sym;
UNSUPPORTED("amu8ypy9stk8vb4g601x25kpb"); // 	     sym = (Agsym_t *) (*(((Dt_t*)(openiconic->dict))->searchf))((openiconic->dict),(void*)(sym),0000010)) {
