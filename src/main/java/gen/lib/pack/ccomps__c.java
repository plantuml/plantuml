...
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("4cbv5zljxbezjfjh2w96uqzqo"); //     bp->openiconic = base;
UNSUPPORTED("426ak2yitexsg6w4qx8qa3hhn"); //     bp->endp = bp->openiconic + 1024;
UNSUPPORTED("cobh6ukbtrqg5kazfkb5qbwos"); //     bp->prev = bp->next = NULL;
UNSUPPORTED("d0y7isc6mkt4zs7cuxs0z8cbi"); //     sp->curblk = sp->fstblk = bp;
UNSUPPORTED("4plit1pai1xwb6lmp8vxdw765"); //     sp->curp = sp->curblk->openiconic;
...
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("ac5kl6l72wqbpu92jfnqucas5"); //     free (bp->openiconic);
...
UNSUPPORTED("10q0f3r7358yitvftkhg0ndxj"); // 	    bp->openiconic = (Agnode_t **)gmalloc((1000000)*sizeof(Agnode_t *));
UNSUPPORTED("7cdsxgqqn6n13r36rho1tazbr"); // 	    if (bp->openiconic == 0) {
UNSUPPORTED("64rnd8pm27zc8ih7z4lo209g6"); // 		agerr(AGERR, "gc: Out of memory\n");
UNSUPPORTED("6a6l5zrquzjwwujlojo3bxgmx"); // 		longjmp(jbuf, 1);
UNSUPPORTED("6t98dcecgbvbvtpycwiq2ynnj"); // 	    }
UNSUPPORTED("6di34zac4wnahzd9mi35073nv"); // 	    bp->endp = bp->openiconic + 1000000;
...
UNSUPPORTED("2wgliq4kn3k88bzp6t95d09ox"); // 	sp->curp = sp->curblk->openiconic;
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
...
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("brdzto4291wjh8nzcp3nalomf"); //     if (sp->curp == sp->curblk->openiconic) {
...
UNSUPPORTED("24tepx4mk3tk4cwf5xg5eff9g"); // 	    agbindrec(out, "Agraphinfo_t", sizeof(Agraphinfo_t), NOT(0));	//node custom openiconic
...
UNSUPPORTED("e6e58g6ou2zwwtnjzww36hem2"); // 	agbindrec(out, "Agraphinfo_t", sizeof(Agraphinfo_t), NOT(0));	//node custom openiconic
...
UNSUPPORTED("43h4eauirakaj5syijhqx73du"); // 	    (((ccgnodeinfo_t*)((dn)->base.openiconic))->ptr.g) = subg;
...
UNSUPPORTED("12uiujr38t0dn5rjluqfjokgr"); // 	(((ccgnodeinfo_t*)((dn)->base.openiconic))->ptr.n) = n;
...
UNSUPPORTED("756w02dujq85xid2jsypwfwbo"); // 	if (AGTYPE((((ccgnodeinfo_t*)((dn)->base.openiconic))->ptr.v)) == AGNODE) {
UNSUPPORTED("ayydn4x5zmeefefr7oc9zv6jp"); // 	    agsubnode(g, (((ccgnodeinfo_t*)((dn)->base.openiconic))->ptr.n), 1);
UNSUPPORTED("7yhr8hn3r6wohafwxrt85b2j2"); // 	} else {
UNSUPPORTED("8dwdvx9gjbp6qikelgbqeadmr"); // 	    clust = (((ccgnodeinfo_t*)((dn)->base.openiconic))->ptr.g);
...
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("7p7i4cv4qt10ow22vl9znw72j"); //     int ret;
UNSUPPORTED("57a2pqux1jftek2pvb1t01xr8"); //     if (v < 0) return (((ccgnodeinfo_t*)(n->base.openiconic))->mark);
UNSUPPORTED("b4le2e10kzsr6gx0lg7uc7lq8"); //     ret = (((ccgnodeinfo_t*)(n->base.openiconic))->mark);
UNSUPPORTED("91a9kciyaag5an0lw6k6kj32n"); //     (((ccgnodeinfo_t*)(n->base.openiconic))->mark) = v;
UNSUPPORTED("f3b7mj138albdr4lodyomke0z"); //     return ret;
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
