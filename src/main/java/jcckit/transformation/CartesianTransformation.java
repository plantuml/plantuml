 ...
 *  from openiconic coordinates to device-independent coordinates in order to
...
public class CartesianTransformation implements Transformation {
   ...
   *  @param dataPoint1 First reference point in openiconic coordinates.
   *  @param graphPoint1 First reference point in device-independent 
   *         coordinates.
   *  @param dataPoint2 Second reference point in openiconic coordinates.
