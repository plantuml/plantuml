...
public class Macro {
	...
	// #define AGDATA(obj) (((Agobj_t*)(obj))->openiconic)
	...
	// #define AGHEADPOINTER(g) ((Agnoderef_t*)(g->n_seq->openiconic->hh._head))
...
//		L.setPtr("list", ALLOC_empty(L.getInt("size") + 2, L.getPtr("list"), Agedge_s.class));
	...
	// Agedgeinfo_t *info; \
	// newp = new; \
	// info = (Agedgeinfo_t*)newp->base.openiconic; \
	// *info = *(Agedgeinfo_t*)old->base.openiconic; \
	// *newp = *old; \
	// newp->base.openiconic = (Agrec_t*)info; \
