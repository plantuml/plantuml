...
class StringDecipherTest {
	...
	void shouldDecipherVariousSvgPaths(String input, String expected) {
		assertEquals(expected, StringDecipher.decipher(input));
	}
	...
	void test1(String input, String expected) {
		assertEquals(expected, StringDecipher.decipherNew(input).toString());
	}
