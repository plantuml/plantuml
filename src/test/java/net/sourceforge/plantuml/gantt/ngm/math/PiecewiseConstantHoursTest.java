...
class PiecewiseConstantHoursTest {
	...
	void setUp() {
		...
		hours = PiecewiseConstantHours.of(Fraction.ZERO).with(new TimeRange(LocalTime.of(8, 0), LocalTime.of(12, 0)), new Fraction(1, 2)).with(new TimeRange(LocalTime.of(14, 0), LocalTime.of(18, 0)), Fraction.ONE);
	}
