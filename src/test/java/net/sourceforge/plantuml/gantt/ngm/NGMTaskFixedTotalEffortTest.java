...
import net.sourceforge.plantuml.gantt.ngm.math.PiecewiseConstantHours;
import net.sourceforge.plantuml.gantt.ngm.math.PiecewiseConstantSpecificDays;
...
class NGMTaskFixedTotalEffortTest {
	...
	private static NGMAllocation officeHours() {
		PiecewiseConstant hours = PiecewiseConstantHours.of(Fraction.ZERO)
				.with(new TimeRange(LocalTime.of(8, 0), LocalTime.of(12, 0)), Fraction.ONE)
				.with(new TimeRange(LocalTime.of(14, 0), LocalTime.of(18, 0)), Fraction.ONE);
	...
	private static NGMAllocation halfTimeOfficeHours() {
		PiecewiseConstant hours = PiecewiseConstantHours.of(Fraction.ZERO)
				.with(new TimeRange(LocalTime.of(8, 0), LocalTime.of(12, 0)), new Fraction(1, 2))
				.with(new TimeRange(LocalTime.of(14, 0), LocalTime.of(18, 0)), new Fraction(1, 2));
