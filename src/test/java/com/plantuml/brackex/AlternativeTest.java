...
public class AlternativeTest {
	...
	@Test
	public void test1() {
		BracketedExpression cut = BracketedExpression.build("【a┇b┇c】");
	...
	@Test
	public void test2() {
		BracketedExpression cut = BracketedExpression.build("【ab┇cd】");
	...
	@Test
	public void test3() {
		BracketedExpression cut = BracketedExpression.build("【〇+a┇〇+b┇〇?c】");
	...
	@Test
	public void test4() {
		BracketedExpression cut = BracketedExpression.build("partition∙〇+〴S∙【 # 〇{6}「0〜9a〜fA〜F」┇ 〇?# 〇+〴w 】");
	...
	@Test
	public void test5() {
		BracketedExpression cut = BracketedExpression.build("partition∙〇+〴S∙# 〇{6}「0〜9a〜fA〜F」");
		assertEquals("partition to #012345", cut.match("partition to #012345").getAcceptedMatch());
	}

	@Test
	public void test50() {
		BracketedExpression cut = BracketedExpression.build("partition∙〇+〴S∙# 〇+「0〜9」");
		assertEquals("partition to #012345", cut.match("partition to #012345").getAcceptedMatch());
	}
