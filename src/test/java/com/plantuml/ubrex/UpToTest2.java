...
public class UpToTest2 {
	...
	public void test3() {
		...
		assertEquals("abcdz", cut.match(TextNavigator.build("abcdzedf")).getAcceptedMatch());
		assertEquals("[a, b, c, d]", cut.match(TextNavigator.build("abcdzedf")).findValuesByKey("txt").toString());
	...
	public void test4() {
		...
		assertEquals("[abcd]", cut.match(TextNavigator.build("abcdzedf")).findValuesByKey("txt").toString());
	...
	public void test5() {
		...
		assertEquals("[abcd]", cut.match(TextNavigator.build("ZabcdZedf")).findValuesByKey("txt").toString());
	...
	public void test7() {
		...
		assertEquals("[abcd, edf]", cut.match(TextNavigator.build("ZabcdZ ZedfZ")).findValuesByKey("txt").toString());
	}
	...
	public void test8() {
		UnicodeBracketedExpression cut = UnicodeBracketedExpression.build("〇+〘 Z〄+〶$txt=〴w -> Z 〇*〴s 〙");
		assertEquals("ZabcdZ ZedfZ", cut.match(TextNavigator.build("ZabcdZ ZedfZ")).getAcceptedMatch());
		assertEquals("[a, b, c, d, e, d, f]", cut.match(TextNavigator.build("ZabcdZ ZedfZ")).findValuesByKey("txt").toString());
	}
